...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  /***/
  function srcAppModelsRegistroModelTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "Registro", function () {
      return Registro;
    });

    var Registro = function Registro(format, num, name) {
  ...
  function srcAppServicesDataLocalServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _models_registro_model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../models/registro.model */
    "./src/app/models/registro.model.ts");
    /* harmony import */
    ...
    var DataLocalService = /*#__PURE__*/function () {
      function DataLocalService(navCtrl, storage) {
        _classCallCheck(this, DataLocalService);

        this.navCtrl = navCtrl;
        this.storage = storage;
        this.guardados = []; // cargar registros
      ...
      _createClass(DataLocalService, [{
                  ...
                  case 0:
                    ...
                    promise = new Promise(function (resolve, reject) {
                      _this.storage.forEach(function (value, key) {
                        _this.guardados.push(value);
                      }).then(function (d) {
                        resolve(_this.guardados); // console.log(this.guardados);
                      });
                    });
                    _context10.next = 3;
                    return promise;
        ...
        key: "guardarRegistro",
        value: function guardarRegistro(format, num, name) {
          //this.cargarStorage();
          var nuevoRegistro = new _models_registro_model__WEBPACK_IMPORTED_MODULE_2__["Registro"](format, num, name);
          this.guardados.unshift(nuevoRegistro); // console.log(this.guardados);
          // guardado local

          this.storage.set(num, this.guardados); //console.log(this.guardados);
        ...
        value: function eliminarRegistro(item) {
          // guardado local
          // this.cargarStorage();
          this.storage.remove(item); //this.cargarStorage();
    ...
    DataLocalService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_4__["NavController"], _ionic_storage__WEBPACK_IMPORTED_MODULE_3__["Storage"]])], DataLocalService);
    /***/
  }
}]);
